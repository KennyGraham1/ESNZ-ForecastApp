function [mCatclus] =  clusterSTEPtime(mCatalog, Mainmag, Mc, startyear, t1, t2)
...
Dtafter = t2/365; %days in decimal years
Dtbefore = t1/365; %days in decimal years
clusterno = 1;
...
for i = 1:le
    ...
    if (b(i,12) == 0 && b(i,6) > Mainmag)
        ...
        latref = b(i,2);
        lonref = b(i,1);
        searchradius=max(5, 10^(0.59*magref-2.44)); %search radius according to Wells-Coppersmith
